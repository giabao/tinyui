...
<UI><!--name of root elem can be any-->
  ...
  <!--Here:
     ...
     + `bmp` is the variable of the building class,
        which is generated by tinyui's UIMacro because the
         above `var="bmp"` attribute of Bitmap node. -->
  <TextField y="bmp.y + bmp.height + PADDING"
             mouseEnabled="shouldEnableTxt()" >
    <TextFormat var="defaultTextFormat"
                size="18" font="'Tahoma'" align="CENTER" color="0xFF0000" />
    <String new="'sandinh.com'" var="text" />
  </TextField>
  
  <TextField text="'Hello TinyUI'">
    <TextFormat function="setTextFormat"
                size="18" font="'Tahoma'" align="CENTER" color="0xFF0000" />
  </TextField>
</UI>
```
